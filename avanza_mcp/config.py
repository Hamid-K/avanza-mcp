...
STOPLOSS_STRATEGY_REGISTRY_FILE = _REPO_ROOT.joinpath(".avanza_stoploss_strategy.json")
POSITION_STRATEGY_REGISTRY_FILE = _REPO_ROOT.joinpath(".avanza_position_strategy.json")
