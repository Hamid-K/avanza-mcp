...
python3 -m py_compile avanza_cli.py tests/test_cli.py tests/test_tui_helpers.py scripts/build_buyback_daily_coverage_json.py scripts/build_catalyst_coverage_audit.py scripts/build_scheduler_coverage_audit.py scripts/build_transaction_coverage_audit.py scripts/enrich_goal_completion_transaction_gate.py scripts/verify_buyback_ladder_artifact.py scripts/verify_catalyst_coverage_artifacts.py scripts/verify_governance_review_streak.py scripts/verify_scheduler_coverage_artifacts.py scripts/verify_transaction_coverage_artifacts.py scripts/enrich_instrument_strategy_scope.py scripts/enrich_portfolio_artifact_scope.py scripts/verify_instrument_strategy_master.py scripts/verify_portfolio_control_artifacts.py scripts/verify_portfolio_scope_artifacts.py scripts/verify_goal_completion_audit.py
